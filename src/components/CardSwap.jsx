...
const CardSwap = ({
    ...
    return (
        <div ref={container} className="card-swap-container" style={{ width, height, position: 'relative' }}>
            {/* We need adjustments because the CSS places it absolutely bottom right, but the user container expects relative positioning often. 
            However, the user asked to put it in a relative div. The CSS has position absolute. 
            We will respect the component code provided.
        */}
            {rendered}
        </div>
    );
